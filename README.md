...
Watch our video result in [YouTube](https://www.youtube.com/watch?v=pW6nZXeWlGM&t=77s) or [here](http://posefs1.perception.cs.cmu.edu/Users/ZheCao/humanpose.mp4). 
...
5. Train
    - Run `bash train_pose.sh 0,1` (generated by setLayers.py) to start the training with two GPUs (0 and 1).
